      ...
      <div className="flex justify-center items-center overflow-hidden">
        {items.map((item, index) => (
          ...
          >
            {index === currentIndex && (
              <div
                className="relative w-full lg:h-96 h-96 text-center bg-white rounded-xl cursor-pointer"
                onClick={toggleFlip}
              >
                  ...
                  {!flipped ? (
                    ...
                    <div className="flex flex-col items-center p-1">
                      <img
                        src={item.image}
                        alt={item.title}
                        className="w-full lg:h-full h-80 object-cover rounded-lg"
                      />
                      <h2 className="lg:text-2xl text-lg lg:mt-2 mt-1 mb-2  text-black">
                        {item.description}
                      </h2>
                    </div>
                  )}
